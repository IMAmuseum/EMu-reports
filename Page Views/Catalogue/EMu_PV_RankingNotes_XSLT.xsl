...
function loaded()
{
    ...
    <xsl:template name="record">
        <center>
            <table border="1" class="sheet">
                ...
                <xsl:call-template name="valuesection" />
                <xsl:call-template name="valuedata" />
            </table>
        </center>
    </xsl:template>
    <!--
                        ...
                        <xsl:choose>
                            <xsl:when test="contains(atom[@name='DesPurpose'], 'Ranking')">
                                <tr class="atomvalue">
                                    ...
                                    <td class="atomvalue">
                                        <xsl:value-of select="atom[@name='NarTitle']" />
                                    </td>
                                </tr>
    ...
    <!--
     ...
     -->
    <xsl:template name="valuesection">
        <tr class="section">
            <td class="section">
                Value Notes
            </td>
            ...
            <td class="values">
                <table border="0" class="data" id="datatable">
                    ...
                    <tr class="atomvalue">
                        ...
                        <td class="atomvalue">
                            <xsl:value-of select="atom[@name='ValDateValued']" />
                        </td>
                    </tr>
                    <tr class="atomvalue">
                        <td class="atomprompt">
                        ...
                        <td class="atomvalue">
                            <xsl:value-of select="tuple[@name='ValValuedByRef']/atom[@name='SummaryData']" />
                        </td>
                    </tr>
                    <tr class="atomvalue">
                        <td class="atomprompt">
                        ...
                        <td class="atomvalue">
                            <xsl:value-of select="atom[@name='ValValuationNotes']" />
                        </td>
                    </tr>
                </table>
            </td>
