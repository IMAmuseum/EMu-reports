...
p
{
    ...
    <xsl:template name="heading">
        <tr class="heading">
            <td class="heading">
                <xsl:text>Total Value Not Estimated</xsl:text>
            </td>
        </tr>
    </xsl:template>
    <!--
    ...
    -->
                            <table border="0" class="data" id="datatable">
                                ...
                                <xsl:choose>
                                    <xsl:when test="atom[@name='ValValuationNotes'] != ''">
                                        <tr class="atomvalue">
                                            <td class="atomvalue">
                                                <xsl:text>Valuation Notes: </xsl:text><xsl:value-of select="atom[@name='ValValuationNotes']"/>
                                            </td>
                                        </tr>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <tr class="atomvalue">
                                            <td class="atomvalue" style="color: red;">
                                                <xsl:text>VALUATION NOTES MISSING</xsl:text>
                                            </td>
                                        </tr>
                                    </xsl:otherwise>
                                </xsl:choose>
