...
p
{
    ...
    -->
                <table class="header">
                        <tr class="atomvalue">
                            <td class="atomvalue">
                                Art Committee Meeting - <xsl:if test="contains(ancestor::tuple/atom[@name='AcqDateAuthorised'], '-01-')"><xsl:text>January </xsl:text><xsl:value-of select="substring(ancestor::tuple/atom[@name='AcqDateAuthorised'],9,2)"/><xsl:text>, </xsl:text><xsl:value-of select="substring(ancestor::tuple/atom[@name='AcqDateAuthorised'],1,4)"/>
                                </xsl:if>
