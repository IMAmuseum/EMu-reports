...
p
{
    ...
    <xsl:template name="body">
        ...
        <!--Original Sort Order
        <xsl:choose>
            <xsl:when test="contains(table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple, 'TR')">
        ...
        <xsl:choose>
            ...
            <xsl:when test="table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple[starts-with(atom[@name='TitAccessionNo'], 'C')]">
                <xsl:for-each select="table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple">
                    <xsl:sort select="atom[@name='TitAccessionNo']"/>
                    <xsl:call-template name="record" />
                    <xsl:if test="position() != last()">
            ...
            <xsl:when test="table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple[starts-with(atom[@name='TitAccessionNo'], 'LH')]">
                <xsl:for-each select="table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple">
                    <xsl:sort select="atom[@name='TitAccessionNo']"/>
                    <xsl:call-template name="record" />
                    <xsl:if test="position() != last()">
            ...
            <xsl:when test="table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple[starts-with(atom[@name='TitAccessionNo'], 'MH')]">
                <xsl:for-each select="table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple">
                    <xsl:sort select="atom[@name='TitAccessionNo']"/>
                    <xsl:call-template name="record" />
                    <xsl:if test="position() != last()">
            ...
            <xsl:when test="table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple[starts-with(atom[@name='TitAccessionNo'], 'N')]">
                <xsl:for-each select="table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple">
                    <xsl:sort select="atom[@name='TitAccessionNo']"/>
                    <xsl:call-template name="record" />
                    <xsl:if test="position() != last()">
            ...
            <xsl:when test="table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple[starts-with(atom[@name='TitAccessionNo'], 'S')]">
                <xsl:for-each select="table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple">
                    <xsl:sort select="atom[@name='TitAccessionNo']"/>
                    <xsl:call-template name="record" />
                    <xsl:if test="position() != last()">
            ...
            <xsl:when test="table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple[starts-with(atom[@name='TitAccessionNo'], 'U')]">
                <xsl:for-each select="table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple">
                    <xsl:sort select="atom[@name='TitAccessionNo']"/>
                    <xsl:call-template name="record" />
                    <xsl:if test="position() != last()">
            ...
            <xsl:when test="table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple[starts-with(atom[@name='TitAccessionNo'], 'WH')]">
                <xsl:for-each select="table[@name='eaccessionlots']/tuple/table[@name='AccAccessionLotRef']/tuple">
                    <xsl:sort select="atom[@name='TitAccessionNo']"/>
                    <xsl:call-template name="record" />
                    <xsl:if test="position() != last()">
    ...
    <xsl:template name="heading">
        <tr class="meeting">
            <td class="meeting">
                <center>
                <xsl:text>Director's Discretionary Acceptance for End of the Year Gifts</xsl:text>
                    <br/>
    ...
    -->
                        <td style="vertical-align: top;">
                            <table border="0" class="data" id="datatable">
                                ...
                                <tr class="atomvalue">
                                    <td class="atomvalue">
                                        <b>Accession No.: </b><xsl:value-of select="atom[@name='TitAccessionNo']"/><xsl:if test="atom[@name='TitPreviousAccessionNo'] != ''"><xsl:text> (</xsl:text><xsl:value-of select="atom[@name='TitPreviousAccessionNo']"/><xsl:text>)</xsl:text></xsl:if>
                                    </td>
                                </tr>
