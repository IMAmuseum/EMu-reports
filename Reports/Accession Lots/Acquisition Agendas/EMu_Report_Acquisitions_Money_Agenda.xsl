...
p
{
    ...
    <xsl:template name="heading">
        <tr class="meeting">
            <td class="meeting">
                <center>
                <xsl:text>Collections Committee Approval</xsl:text>
                    <br/>
        ...
        <tr class="heading">
            <td class="heading">
                <xsl:if test="ancestor::tuple/atom[@name='AcqAcquisitionMethod'] = 'Acquisition - Purchase'">
                    <xsl:choose>
                        <xsl:when test="ancestor::tuple/table[@name='AccAccessionLotRef']/tuple[2] or ancestor::table[@name='eaccessionlots']/tuple[2]">
                    <b>Purchases for the <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '901.1-European')">European Painting and Sculpture 1800-1945</xsl:if>
                    ...
                    <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '981-Lilly')">Lilly House</xsl:if>
                        <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '982-Miller')">Miller House</xsl:if> Department</b>
                    </xsl:when>
                    <xsl:otherwise>
                        <b>Purchase for the <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '901.1-European')">European Painting and Sculpture 1800-1945</xsl:if>
                            <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '901.2-American')">American Painting and Sculpture 1800-1945</xsl:if>
                            <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '902.1-European')">European Painting and Sculpture Before 1800</xsl:if>
                            <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '903.1-Decorative')">Decorative Arts</xsl:if>
                            <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '903.2-Design')">Design Arts</xsl:if>
                ...
                <xsl:if test="ancestor::tuple/atom[@name='AcqAcquisitionMethod'] = 'Acquisition - Gift'">
                    <xsl:choose>
                        <xsl:when test="ancestor::tuple/table[@name='AccAccessionLotRef']/tuple[2]">
                            <b>Gifts for the <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '901.1-European')">European Painting and Sculpture 1800-1945</xsl:if>
                            <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '901.2-American')">American Painting and Sculpture 1800-1945</xsl:if>
                            <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '902.1-European')">European Painting and Sculpture Before 1800</xsl:if>
                            <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '903.1-Decorative')">Decorative Arts</xsl:if>
                            <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '903.2-Design')">Design Arts</xsl:if>
                        ...
                        <xsl:otherwise>
                            <b>Gift for the <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '901.1-European')">European Painting and Sculpture 1800-1945</xsl:if>
                            <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '901.2-American')">American Painting and Sculpture 1800-1945</xsl:if>
                            <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '902.1-European')">European Painting and Sculpture Before 1800</xsl:if>
                            <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '903.1-Decorative')">Decorative Arts</xsl:if>
                            <xsl:if test="starts-with(ancestor::tuple/atom[@name='LotDepartment'], '903.2-Design')">Design Arts</xsl:if>
