...
<!-- Creator logic -->
            ...
            <div class="condition">
                ...
                <br/>
                <xsl:choose>
                    <xsl:when test="contains(translate(atom[@name='ConConditionDetails'], 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'treatment needed:')">
                <div>
                    <b>Treatment Needed: </b><xsl:if test="contains(translate(atom[@name='ConConditionDetails'], 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'treatment needed: y')">_____ No __<u>X</u>__ Yes</xsl:if><xsl:if test="contains(translate(atom[@name='ConConditionDetails'], 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'treatment needed: n')">__<u>X</u>__ No _____ Yes</xsl:if><xsl:if test="contains(translate(atom[@name='ConConditionDetails'], 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'treatment needed: rec')">Recommended but not required</xsl:if><br/>
