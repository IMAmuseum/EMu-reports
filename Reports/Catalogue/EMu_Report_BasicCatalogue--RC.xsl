...
p
{
    ...
    <xsl:template name="body">
        ...
        <xsl:for-each select="table[@name='ecatalogue']/tuple[not(starts-with(atom[@name='TitAccessionNo'], 'C')) and not(starts-with(atom[@name='TitAccessionNo'], 'LH')) and not(starts-with(atom[@name='TitAccessionNo'], 'MH')) and not(starts-with(atom[@name='TitAccessionNo'], 'N')) and not(starts-with(atom[@name='TitAccessionNo'], 'S')) and not(starts-with(atom[@name='TitAccessionNo'], 'TR')) and not(starts-with(atom[@name='TitAccessionNo'], 'U')) and not(starts-with(atom[@name='TitAccessionNo'], 'WH'))]">
            <xsl:sort select="substring-after(atom[@name='PhyCollectionArea'], '-')"/>
                        ...
                        <td style="vertical-align: top;">
                            <table border="0" class="data" id="datatable">
                                ...
                                <xsl:choose>
                                    ...
                                    <tr class="atomvalue">
                                        <td class="atomvalue">
                                            <b>Rank: </b><xsl:text>No Ranking</xsl:text>
                                        </td>
                                    </tr>
                                    </xsl:otherwise>
                                </xsl:choose>
                                <xsl:choose>
                                    <xsl:when test="atom[@name='ValValuationAmount'] != ''">
                                    <tr class="atomvalue">
                                        <td class="atomvalue">
                                        <b>Value: </b>$<xsl:value-of select="atom[@name='ValValuationAmount']"/>
                                        </td>
                                    </tr>
                                    </xsl:when>
                                    <xsl:otherwise>
                                    <tr class="atomvalue">
                                        <td class="atomvalue">
                                            <b>Value: </b><xsl:text>Unkown</xsl:text>
                                        </td>
                                    </tr>
                                    </xsl:otherwise>
                                    </xsl:choose>
                                    ...
                                    <tr class="atomvalue">
                                        <td class="atomvalue">
                                            <b>Department: </b><xsl:value-of select="substring-after(atom[@name='PhyCollectionArea'], '-')"/>
                                        </td>
                                    </tr>
                            </table>
                        </td>
