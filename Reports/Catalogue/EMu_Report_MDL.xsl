    ...
    -->
                        <td style="vertical-align: top;">
                            <table border="0" class="data" id="datatable">
                                ...
                                <xsl:if test="table[@name='CreCreationCultureOrPeople_tab']">
                                    <tr class="atomvalue">
                                        <td class="atomvalue">
                                            <b>Culture/People: </b><xsl:for-each select="table[@name='CreCreationCultureOrPeople_tab']/tuple"><xsl:value-of select="atom[@name='CreCreationCultureOrPeople']"/><xsl:if test="position() != last()"><xsl:text>, </xsl:text></xsl:if></xsl:for-each>
                                        </td>
                                    </tr>
                                </xsl:if>
                                <xsl:if test="atom[@name='CreCreationPeriod'] != ''">
                                    <tr class="atomvalue">
                                        <td class="atomvalue">
                                            <b>Period: </b><xsl:value-of select="atom[@name='CreCreationPeriod']"/>
                                        </td>
                                    </tr>
                                </xsl:if>
                                <xsl:if test="atom[@name='CreCreationDynasty'] != ''">
                                    <tr class="atomvalue">
                                        <td class="atomvalue">
                                            <b>Dynasty: </b><xsl:value-of select="atom[@name='CreCreationDynasty']"/>
                                        </td>
                                    </tr>
                                </xsl:if>
                                ...
                                <xsl:if test="table[@name='Type']">
                                    <tr class="atomvalue">
                                        <td class="atomvalue">
                                            <b>Object Type(s): </b><xsl:for-each select="table[@name='Type']/tuple"><xsl:value-of select="atom[@name='PhyMediaCategory']"/><xsl:if test="position() != last()"><xsl:text>, </xsl:text></xsl:if></xsl:for-each>
                                        </td>
                                    </tr>
                                </xsl:if>
                                ...
                                <xsl:if test="atom[@name='PhyDescription'] != ''">
                                    <tr class="atomvalue">
                                        <td class="atomvalue">
                                            <b>Description: </b><xsl:value-of select="atom[@name='PhyDescription']"/>
                                        </td>
                                    </tr>
                                </xsl:if>
                                <xsl:if test="atom[@name='PhyStyle'] != ''">
                                    <tr class="atomvalue">
                                        <td class="atomvalue">
                                            <b>Style: </b><xsl:value-of select="atom[@name='PhyStyle']"/>
                                        </td>
                                    </tr>
                                </xsl:if>
                                ...
                                <xsl:if test="table[@name='RigRightsRef_tab']/tuple/atom[@name='RigAcknowledgement'] != ''">
                                    <tr class="atomvalue">
                                        <td class="atomvalue">
                                            <b>Copyright: </b><xsl:value-of select="table[@name='RigRightsRef_tab']/tuple/atom[@name='RigAcknowledgement']" />
                                        </td>
                                    </tr>
                                </xsl:if>
