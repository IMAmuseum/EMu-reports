...
<xsl:template match="/">{"parties": [
    <xsl:for-each select="table[@name='eparties']/tuple"><xsl:sort select="atom[@name='irn']" data-type="number"/>{
        ...
        "full_name": <xsl:choose><xsl:when test="normalize-space(atom[@name='NamFullName']) != ''">"<xsl:call-template name="escape_characters"><xsl:with-param name="input_string"><xsl:value-of select="atom[@name='NamFullName']"/></xsl:with-param></xsl:call-template>"</xsl:when><xsl:when test="normalize-space(atom[@name='NamOrganisation']) != ''">"<xsl:call-template name="escape_characters"><xsl:with-param name="input_string"><xsl:value-of select="atom[@name='NamOrganisation']"/></xsl:with-param></xsl:call-template>"</xsl:when><xsl:when test="normalize-space(atom[@name='ColCollaborationName']) != ''">"<xsl:call-template name="escape_characters"><xsl:with-param name="input_string"><xsl:value-of select="atom[@name='ColCollaborationName']"/></xsl:with-param></xsl:call-template>"</xsl:when><xsl:otherwise>null</xsl:otherwise></xsl:choose>,
